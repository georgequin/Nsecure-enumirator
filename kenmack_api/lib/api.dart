...
part 'api/profession_controller_api.dart';
part 'api/service_controller_api.dart';
part 'api/user_controller_api.dart';

part 'model/country_pojo.dart';
part 'model/email_sender_dto.dart';
part 'model/email_verification_dto.dart';
...
part 'model/verify_password_code_dto.dart';
